...
*
* Benchmark for Lab Asignment 3 - Part 3
* Multiple iterations of the same subroutine named BYPASSING
*
* subrutines: BYPASSING, ESCRIBIR_JTAG, activaTimer, desactivaTimer, PRINT_JTAG 
*
* files: DIV.s, escribir_jtag.s, bypassing.s, BCD.s
*
* Domingo Benitez
* November 2024
*
*************************************************************/
.equ ITER_BENCH,1 	 		/* number of kernel iterations */
...
/* rutina kernel */
	jal  	ra,	BYPASSING				/* kernel de computo */
