...
/* s2 =  dirección base del puerto JTAG */
/* s10 = caracter a procesar */
...
ESCRIBIR_JTAG:
	...
	/* Puerto JTAG-UART */
	la   s2, 0x10001000		/* direccion base de controlador JTAG_UART */
...
.global PRINT							/* PRINT(a0 = direccion_TEXTO) */
PRINT:									/* subrutina de gestion del timer: muestra mensaje */
	addi 	sp, sp, -16
	sw 		s10,  4(sp)
	sw 		ra,   8(sp)
	sw 		t2,  12(sp)
...
/* Rutina PRINT_REGISTRO: carga una palabra de memoria en formato BCD y lo muestra por JTAG en una terminal */

.global PRINT_REGISTRO				/* PRINT(a0 = direccion cuyo valor se muestra) */
PRINT_REGISTRO:						/* subrutina de gestion del timer: muestra mensaje */
	addi 	sp, sp, -16
	sw 		s10,  4(sp)
	sw 		ra,   8(sp)
	sw 		t2,  12(sp)
...
BUCLE_PRINT_REGISTRO:
	...
	addi  	s10, s10, 0x30			/* suma 0x30: BCD -> ASCII */ 
	jal  	ra,  ESCRIBIR_JTAG 		/* subrutina que muestra el byte por JTAG-UART */
